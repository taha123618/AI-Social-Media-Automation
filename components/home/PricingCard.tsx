...
export const PricingCard = ({
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      className={`relative p-10 rounded-[2.5rem] border transition-all duration-500 flex flex-col h-full bg-white dark:bg-slate-900 ${
        popular
    ...
    >
      ...
      <Button
        ...
        className={`w-full py-7 rounded-2xl text-lg font-black transition-all active:scale-95 flex items-center justify-center gap-2 ${
          popular
