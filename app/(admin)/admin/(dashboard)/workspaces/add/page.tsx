...
import { createBusiness } from "../../../actions/admin.actions";
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-foreground">Initialize Workspace Node</h1>
          </div>
        </div>
      </div>
      ...
      >
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground font-medium">Define metadata and routing protocols for the new business cluster.</p>
          </div>
