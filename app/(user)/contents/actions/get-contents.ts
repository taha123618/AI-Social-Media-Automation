...
import { SearchParams, ContentsResponse, ContentDraft } from '../types';
import { getActiveWorkspaceIdSafe } from '@/app/(user)/actions/workspace';

export async function getContents(searchParams: SearchParams): Promise<ContentsResponse> {
  ...
  return {
    contents: contents as unknown as ContentDraft[],
    pagination: {
      page,
      limit,
      total,
