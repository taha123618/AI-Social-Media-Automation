  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center py-20">
      <div className="mx-auto max-w-md px-6 text-center">
        ...
        <h1 className="text-3xl font-black text-foreground mb-3">Thank You Page Error</h1>
        <p className="text-muted-foreground mb-8">
          We encountered an issue loading this page. Please try again or return home.
        </p>
