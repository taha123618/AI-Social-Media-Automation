...
const PLANS = [
  ...
  },
  {
    ...
    bg: "bg-gradient-to-b from-blue-600/20 to-violet-600/10",
    badge: "Most Popular",
    cta: "Start free trial",
    ctaStyle: "bg-blue-600 hover:bg-blue-500 text-white shadow-2xl shadow-blue-500/30",
    features: [
  ...
  },
  {
    ...
    bg: "bg-white/[0.02]",
    cta: "Contact sales",
    ctaStyle: "bg-violet-600/20 hover:bg-violet-600/30 text-white border border-violet-500/30",
    features: [
      "Unlimited articles",
...
export default function BlogPricing() {
  ...
  return (
    <section id="pricing" className="relative py-32 bg-background overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-primary/5 rounded-full blur-[140px] pointer-events-none dark:bg-primary/5" />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
          ...
          {PLANS.map((plan, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative p-8 rounded-3xl border ${plan.border} ${plan.bg} flex flex-col`}
              >
                {plan.badge && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="bg-blue-600 text-white text-xs font-black px-4 py-1.5 rounded-full shadow-lg shadow-blue-500/30">
                      {plan.badge}
                    </span>
                  </div>
                )}
                ...
                <div className="mb-8">
                  {price !== null ? (
                    <div className="flex items-end gap-2">
                      ...
                      <div className="text-3xl font-black text-foreground">Custom pricing</div>
                  )}
                  {annual && price !== null && mounted && (
        ...
        >
          ...
          Questions? <Link href="/contact" className="text-primary hover:underline">Chat with us</Link>.
        </motion.p>
      </div>
    </section>
  );
